...
const metaDataPromise = fetch('../../static/explorables/data/experiment_2_2023-12-11.json.gz')
...
const trajectoryDataPromise = fetch('../../static/explorables/data/experiment_2_trajectory_2023-12-11.json.gz')
  .then(response => response.blob())
  .then(compressedBlob => {
    const ds = new DecompressionStream("gzip");
    const decompressedStream = compressedBlob.stream().pipeThrough(ds);
